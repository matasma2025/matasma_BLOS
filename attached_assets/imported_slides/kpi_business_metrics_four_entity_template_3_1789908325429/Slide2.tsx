      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{in_budget_revenue_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{in_budget_revenue_detail}}"}</span></p></div><div key={37} style={{
        position: "absolute",
        left: "64.32px",
        top: "315.84px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{in_internal_utilization_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{in_internal_utilization_detail}}"}</span></p></div><div key={39} style={{
        position: "absolute",
        left: "63.04px",
        top: "435.8px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{in_external_utilization_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{in_external_utilization_detail}}"}</span></p></div><div key={41} style={{
        position: "absolute",
        left: "67.2px",
        top: "575.05px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{in_capacity_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{in_capacity_detail}}"}</span></p></div><svg key={43} style={{
        position: "absolute",
        left: "51.84px",
        top: "711.85px",
        width: "1184.64px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#626262"
          }}>{"{{in_source_note}}  \u2022  Actuals: {{in_actual_source_label}}  \u2022  Forecast: {{in_forecast_source_label}}  \u2022  {{in_period_label}}"}</span></p></div><div key={46} style={{
        position: "absolute",
        left: "51.84px",
        top: "779.05px",
        width: "1178.88px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#626262"
          }}>{"Warnings / data-quality notes: {{in_warnings}}"}</span></p></div><div key={47} style={{
        position: "absolute",
        left: "989.76px",
        top: "823.21px",
        width: "240px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#626262"
          }}>{"{{in_entity_label}}  \u2022  Slide 2 of 4"}</span></p></div><div key={48} style={{
        position: "absolute",
        left: "0px",
        top: "840px",
        width: "480px",
