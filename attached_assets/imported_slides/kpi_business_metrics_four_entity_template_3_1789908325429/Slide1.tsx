      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{ww_budget_revenue_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{ww_budget_revenue_detail}}"}</span></p></div><div key={37} style={{
        position: "absolute",
        left: "63.36px",
        top: "328.63px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{ww_internal_utilization_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{ww_internal_utilization_detail}}"}</span></p></div><div key={39} style={{
        position: "absolute",
        left: "64.32px",
        top: "446.86px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{ww_external_utilization_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{ww_external_utilization_detail}}"}</span></p></div><div key={41} style={{
        position: "absolute",
        left: "64.32px",
        top: "581.56px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{ww_capacity_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{ww_capacity_detail}}"}</span></p></div><svg key={43} style={{
        position: "absolute",
        left: "50.56px",
        top: "767.09px",
        width: "1184.64px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(6pt * var(--pptx-font-scale, 1))",
            fontFamily: "Arial, 'Helvetica Neue', sans-serif"
          }}>{"{{ww_source_note}}  \u2022  Actuals: {{ww_actual_source_label}}  \u2022  Forecast: {{ww_forecast_source_label}}  \u2022  {{ww_period_label}}"}</span></p></div><div key={46} style={{
        position: "absolute",
        left: "50.56px",
        top: "781.69px",
        width: "1178.88px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(6pt * var(--pptx-font-scale, 1))",
            fontFamily: "Arial, 'Helvetica Neue', sans-serif"
          }}>{"Warnings / data-quality notes: {{ww_warnings}}"}</span></p></div><div key={47} style={{
        position: "absolute",
        left: "988.48px",
        top: "825.85px",
        width: "240px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(6pt * var(--pptx-font-scale, 1))",
            fontFamily: "Arial, 'Helvetica Neue', sans-serif"
          }}>{"{{ww_entity_label}}  \u2022  Slide 1 of 4"}</span></p></div><div key={48} style={{
        position: "absolute",
        left: "0px",
        top: "840px",
        width: "480px",
