      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{vn_budget_revenue_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{vn_budget_revenue_detail}}"}</span></p></div><div key={37} style={{
        position: "absolute",
        left: "64.32px",
        top: "315.84px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{vn_internal_utilization_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{vn_internal_utilization_detail}}"}</span></p></div><div key={39} style={{
        position: "absolute",
        left: "67.2px",
        top: "444.99px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{vn_external_utilization_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{vn_external_utilization_detail}}"}</span></p></div><div key={41} style={{
        position: "absolute",
        left: "63.04px",
        top: "579.84px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{vn_capacity_summary}}"}</span></p><p style={{
          lineHeight: "1.2",
          fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"{{vn_capacity_detail}}"}</span></p></div><svg key={43} style={{
        position: "absolute",
        left: "46.08px",
        top: "722.87px",
        width: "1184.64px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#626262"
          }}>{"{{vn_source_note}}  \u2022  Actuals: {{vn_actual_source_label}}  \u2022  Forecast: {{vn_forecast_source_label}}  \u2022  {{vn_period_label}}"}</span></p></div><div key={46} style={{
        position: "absolute",
        left: "46.08px",
        top: "779.49px",
        width: "1178.88px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#626262"
          }}>{"Warnings / data-quality notes: {{vn_warnings}}"}</span></p></div><div key={47} style={{
        position: "absolute",
        left: "984px",
        top: "823.65px",
        width: "240px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#626262"
          }}>{"{{vn_entity_label}}  \u2022  Slide 3 of 4"}</span></p></div><div key={48} style={{
        position: "absolute",
        left: "0px",
        top: "840px",
        width: "480px",
