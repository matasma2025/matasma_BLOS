      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"1) YTD 07.26 Actual 29.9 mUSD is higher by 1.1 mUSD compared with Forecast 28.8 mUSD.\nMS: YTD 07.26 Actual 21.7 mUSD is lower by 0.2 mUSD compared with Forecast 21.9 mUSD.\nMM: YTD 07.26 Actual 7.5 mUSD is higher by 1.5 mUSD compared with Forecast 5.9 mUSD.\nSDS: YTD 07.26 Actual 0.7 mUSD is lower by 0.3 mUSD compared with Forecast 1 mUSD."}</span></p></div><div key={37} style={{
        position: "absolute",
        left: "66.33px",
        top: "359.79px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"1) YTD 07.26 is 92.2%; YTD 07.25: \u2014; YTD 06.26 is \u2014\nMS: YTD 07.26 is 91.8%; YTD 07.25: \u2014; YTD 06.26 is \u2014\nMM: YTD 07.26 is 94%; YTD 07.25: \u2014; YTD 06.26 is \u2014"}</span></p></div><div key={39} style={{
        position: "absolute",
        left: "64.32px",
        top: "518.84px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"1) YTD 07.26 Actual 634.8 HC is higher by 7.8 HC compared with Forecast 627 HC.\nMS: YTD 07.26 Actual 456.5 HC is lower by 7.5 HC compared with Forecast 464 HC.\nMM: YTD 07.26 Actual 156.5 HC is higher by 20.5 HC compared with Forecast 136 HC.\nSDS: YTD 07.26 Actual 21.8 HC is lower by 5.2 HC compared with Forecast 27 HC."}</span></p></div><svg key={41} style={{
        position: "absolute",
        left: "54.72px",
        top: "713.25px",
        width: "1184.64px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif",
            color: "#626262"
          }}>{"Governed green scope  \u2022  Actuals: Anaplan actuals \xB7 unversioned actual export rows  \u2022  Forecast: MBR workbook \xB7 YTD Forecast  \u2022  YTD 07.26"}</span></p></div><div key={44} style={{
        position: "absolute",
        left: "54.72px",
        top: "780.45px",
        width: "1178.88px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif",
            color: "#626262"
          }}>{"Warnings / data-quality notes: Mexico: External Utilization has no actual source rows."}</span></p></div><div key={45} style={{
        position: "absolute",
        left: "996.73px",
        top: "827.77px",
        width: "240px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif",
            color: "#626262"
          }}>{"NE-MX  \u2022  Slide 4 of 4"}</span></p></div><div key={46} style={{
        position: "absolute",
        left: "0px",
        top: "840px",
        width: "480px",
