      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#A83678"
          }}>{"ACTIVE"}</span></p></div><div key={17} style={{
        position: "absolute",
        left: "420.48px",
        top: "95.04px",
        width: "201.6px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#303030"
          }}>{"India (IN)"}</span></p></div><div key={23} style={{
        position: "absolute",
        left: "644.16px",
        top: "95.04px",
        width: "201.6px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#303030"
          }}>{"Vietnam (VN)"}</span></p></div><div key={27} style={{
        position: "absolute",
        left: "867.84px",
        top: "95.04px",
        width: "201.6px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#A83678"
          }}>{"Decision / info to GLs \u2014 World Wide"}</span></p></div><div key={35} style={{
        position: "absolute",
        left: "64.32px",
        top: "205.44px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"1) YTD 07.26 Actual 915.9 mUSD is higher by 23.6 mUSD compared with Forecast 892.3 mUSD.\nMS: YTD 07.26 Actual 612.3 mUSD is higher by 6.8 mUSD compared with Forecast 605.4 mUSD.\nMM: YTD 07.26 Actual 56.1 mUSD is higher by 1.8 mUSD compared with Forecast 54.4 mUSD.\nSDS: YTD 07.26 Actual 58.9 mUSD is higher by 4.2 mUSD compared with Forecast 54.7 mUSD.\nMS-External: YTD 07.26 Actual 19.1 mUSD is lower by 0.8 mUSD compared with Forecast 19.9 mUSD.\nIntegrated Service: YTD 07.26 Actual 166.7 mUSD is higher by 12.1 mUSD compared with Forecast 154.5 mUSD."}</span></p></div><div key={37} style={{
        position: "absolute",
        left: "63.36px",
        top: "328.63px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"1) YTD 07.26 is 94.7%; YTD 07.25: \u2014; YTD 06.26 is \u2014\nMS: YTD 07.26 is 94.7%; YTD 07.25: \u2014; YTD 06.26 is \u2014\nMM: YTD 07.26 is 94.2%; YTD 07.25: \u2014; YTD 06.26 is \u2014"}</span></p></div><div key={39} style={{
        position: "absolute",
        left: "64.32px",
        top: "446.86px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"1) YTD 07.26 is 100.8%; YTD 07.25: \u2014; YTD 06.26 is \u2014\nMS: YTD 07.26 is 100.6%; YTD 07.25: \u2014; YTD 06.26 is \u2014\nMM: YTD 07.26 is 102.3%; YTD 07.25: \u2014; YTD 06.26 is \u2014"}</span></p></div><div key={41} style={{
        position: "absolute",
        left: "64.32px",
        top: "581.56px",
        width: "384px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(8pt * var(--pptx-font-scale, 1))",
            fontFamily: "'Calibri', 'Helvetica Neue', Arial, sans-serif"
          }}>{"1) YTD 07.26 Actual 31,530.6 HC is higher by 89.9 HC compared with Forecast 31,440.8 HC.\nMS: YTD 07.26 Actual 20,090.2 HC is lower by 110.6 HC compared with Forecast 20,200.9 HC.\nMM: YTD 07.26 Actual 1,913.5 HC is higher by 70.4 HC compared with Forecast 1,843.1 HC.\nSDS: YTD 07.26 Actual 2,102.5 HC is higher by 31.5 HC compared with Forecast 2,071 HC.\nIntegrated Service: YTD 07.26 Actual 7,093.5 HC is higher by 63.4 HC compared with Forecast 7,030.1 HC."}</span></p></div><svg key={43} style={{
        position: "absolute",
        left: "50.56px",
        top: "767.09px",
        width: "1184.64px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(6pt * var(--pptx-font-scale, 1))",
            fontFamily: "Arial, 'Helvetica Neue', sans-serif"
          }}>{"World Wide  \u2022  Slide 1 of 4"}</span></p></div><div key={48} style={{
        position: "absolute",
        left: "0px",
        top: "840px",
        width: "480px",
