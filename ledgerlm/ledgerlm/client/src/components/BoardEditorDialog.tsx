  ...
  const getInitialFormData = () => {
    ...
    return {
      ...
      scope: {
        ...
        forecastScenario: src?.boardFlow?.scope?.forecastScenario ?? (isEntityPnlTemplate ? '' : 'YTD Forecast'),
        pnlComparison: src?.boardFlow?.scope?.pnlComparison ?? 'qoq',
        currency: src?.boardFlow?.scope?.currency ?? 'INR',
      },
